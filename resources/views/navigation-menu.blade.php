            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="felx">
                    ...
                    <div class="bg-blue-200 rounded-full">
                        <a href="/panier" class="p-2 rounded  leading-none flex items-center">
                            <img href="/panier" src={{ asset('images/panier.png') }} class="w-8 h-8">
                            <span class="bg-white p-1 rounded text-blue-600 text-xs">{{Cart::count()}}</span>
                        </a>
                    </div>
